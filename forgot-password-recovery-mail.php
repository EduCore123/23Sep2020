...
$mail->SMTPSecure = "tls";
$mail->Port     = 587;
$mail->Username = 'shubhangighadge45@gmail.com';    ;
$mail->Password = 'shubhangiv' ;
$mail->Host     =  'smtp.gmail.com';  // Specify main and backup SMTP servers;
$mail->Mailer   = MAILER;

$mail->SetFrom('shubhangighadge45@gmail.com', 'shubhangi ghadge');
$mail->AddReplyTo('shubhangighadge45@gmail.com', 'shubhangi ghadge');
$mail->ReturnPath='shubhangighadge45@gmail.com';
