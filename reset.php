  ...
  <section>
    <div class="ftco-section contact-section bg-light">
      <div class="container">
        ...
        <h5 class="text text-center text-success"><?php echo $_SESSION['msg1']; ?><?php echo $_SESSION['msg1'] = ""; ?></h5>
        <form name="chngpwd" action="" method="post" onSubmit="return valid();">
          ...
          <button type="submit" name="submit" class="btn btn-primary"> <?php echo $lang['changepassword'] ?></button>
          <button type="reset" class="btn btn-primary"><?php echo $lang['reset'] ?></button>
          <br>
          <br>
          <a href="login.php"><?php echo $lang['backlog'] ?></a> </p>
        </form>
      </div>
    </div>
  </section>
