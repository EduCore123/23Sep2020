            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 col-md-10">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div class="col-4 pl-0"> <label><?php echo $lang['jobby'] ?>:</label><span style="color: black"><?= $record['jobby'] ?></span></div>
                   <div class="col-4 pl-0"> <label ><?php echo $lang['jobadd'] ?>:</label><span style="color: black"><?= $record['jobvillage'] ?>,<?= $record['jobtaluka'] ?>,<?= $record['jobdistrict'] ?>,<?= $record['jobstate'] ?></span></div>
                </div>
              </div>

              <div class="ml-auto d-flex col-md-2">
                <a href="applyjob.php?job_id=<?= $record['job_id'] ?>&jobkey=<?= $record['jobkey']  ?> " class="btn btn-primary py-2 mr-1">Apply Job</a>
