          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about.php" class="py-2 d-block"><?php echo $lang['blog'] ?></a></li>
                <li><a href="#" class="py-2 d-block"><?php echo $lang['faq'] ?></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="index.php"  class="py-2 d-block"><?php echo $lang['jobsearch'] ?></a></li>
                <li><a href="index.php" class="py-2 d-block"><?php echo $lang['es'] ?></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
