      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.html"><?php echo $lang['home'] ?> <i class="ion-ios-arrow-forward"></i></a></span> <span><?php echo $lang['postjob'] ?></span></p>
              ...
              <div class="row form-group">
               ...
               <div class="row form-group ">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="jobvillage" name="jobvillage"  class="form-control" placeholder=" ">
                </div>
              </div>
               <div class="row form-group ">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" ><?php echo $lang['taluka'] ?></label>
                  <input type="text" id="jobtaluka" name="jobtaluka"  class="form-control" placeholder=" ">
                </div>
              </div>
               <div class="row form-group ">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" ><?php echo $lang['district'] ?></label>
                  <input type="text" id="jobdistrict" name="jobdistrict"  class="form-control" placeholder=" ">
                </div>
              </div>
               <div class="row form-group ">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname"><?php echo $lang['state'] ?></label>
                  <input type="text" id="jobstate" name="jobstate"  class="form-control" placeholder=" ">
                </div>
              </div>
              <div class="row form-group ">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname"><?php echo $lang['postby'] ?></label>
                  <input type="text" id="jobby" name="jobby"  class="form-control" placeholder=" ">
                </div>
              </div>
