      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.php"><?php echo $lang['home'] ?> <i class="ion-ios-arrow-forward"></i></a></span> <span><?php echo $lang['regi'] ?></span></p>
  ...
  <h2><?php echo $lang['edit'] ?></h2>
   <form method="post" action="updateprofile.php">
        ...
        <div class='form-group'>
            ...
            <input name='gender' id='gender'  value="<?php echo $_SESSION['gender'];?>"  class='form-control' type='text' placeholder='<?php echo $lang['gender'] ?>' required>
        </div>
         <div class='form-group'>
        ...
        <div class='form-group'>
            ...
            <input name='mobile' id='mobile'  value="<?php echo $_SESSION['mobile'];?>"  class='form-control' type='text' placeholder='<?php echo $lang['mobileno'] ?>' required>
        </div>
         <div class='form-group'>
            <label for='type'><?php echo $lang['type'] ?></label>
            <input name='type' id='type'  value="<?php echo $_SESSION['type'];?>"  class='form-control' type='text' placeholder='<?php echo $lang['type'] ?>' >
        </div>
        
        <div class='form-group'>
            <input type="submit"  value="<?php echo $lang['edit'] ?>" class="btn btn-success">
            <a href="reset.php"> <input value="<?php echo $lang['resetpassword'] ?>" class="btn btn-success"></a>
        </div>
</div>
</form>
</div>
